        ...
        renderChilds: function(params) {
            ...
            this.tabModel = new App.Model.TabModel(
                    {
                        tabs: [
                            ...
                            ,
                            {label: "Récords", name: "records", enable: true},
                            ,
                            {label: "Estadios", name: "stadiums", enable: true},
                            ,
                            {label: "Arbitros", name: "referees", enable: true},
                            ,
                            {label: "Arbitros suplentes", name: "secondaryReferees", enable: true},
                        ]
                    }
            );
            ...
            var options = {
                success: function() {
                    ...
                    self.stadiumsToolbarModel.set('addName' , 'Añadir');
                    ...
                    self.refereesToolbarModel.set('addName' , 'Añadir');
                    ...
                    self.secondaryRedereesToolbarModel.set('addName' , 'Añadir');
                    ...
                    Backbone.on(self.refereesComponent.componentId + '-toolbar-add', function() {
                        ...
                        App.Utils.getComponentList('refereeComponent', function(componentName, model) {
                            if (model.models.length == 0) {
                                alert('No hay arbitros para selecionar.');
                            } else {
                    ...
                    Backbone.on(self.secondaryRefereesComponent.componentId + '-toolbar-add', function() {
                        ...
                        App.Utils.getComponentList('refereeComponent', function(componentName, model) {
                            if (model.models.length == 0) {
                                alert('No hay arbitros suplentes para selecionar.');
                            } else {
